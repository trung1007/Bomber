...
public class Bomb extends  Entity{
    ...
    public int check_flame_collision(int pos_bomb_up, int pos_bomb_down, int pos_bomb_right, int pos_bomb_left, int bombX, int bombY, Object object) {
        int check = 0;
                    ...
                    if (image == null) {
                        ...
                        if (countTime <= isExploring) {
                            ...
                            for (int i = 1; i <= sizeBomb; i++) {
                                ...
                                //int check_flame=check_flame_collision(pos_bomb_up,pos_bomb_down,pos_bomb_right,pos_bomb_left,bombX,bombY,1,object);
