...
//                            gamePanel.checkCollision.checkDie(bomber, this);
                        if (collisionWallUp || collisionBrickUp) {
                            ...
                            if (collisionBrickUp && checkUp == false) {
                        ...
                        if (collisionWallDown || collisionBrickDown) {
                            ...
                            if (collisionBrickDown && checkDown == false) {
                                object.mapObjectNum[(bombY + i * rect) / rect][bombX / rect] = 3;
                                checkDown = true;
                            }
                        }
                        if (collisionWallLeft || collisionBrickLeft) {
                            ...
                            if (collisionBrickLeft && checkLeft == false) {
                        ...
                        if (collisionWallRight || collisionBrickRight) {
                            ...
                            if (collisionBrickRight && checkRight == false) {
                                object.mapObjectNum[(bombY) / rect][(bombX + i * rect) / rect] = 3;
                                checkRight = true;
                            }
                        }
...
//                            gamePanel.checkCollision.checkDie(bomber, this);
                    ...
                    for (int i = 1; i <= sizeBomb; i++) {
                        ...
                        if (collisionWallUp || collisionBrickUp) {
                            ...
                            if (collisionBrickUp && countTime < timeExploring * 3 && checkUp == false) {
                                object.mapObjectNum[(bombY - i * rect) / rect][bombX / rect] = 4;
                                checkUp = true;
                            } else if (collisionBrickUp && countTime >= timeExploring * 3 && checkUp == false) {
                        ...
                        if (collisionWallDown || collisionBrickDown) {
                            ...
                            if (collisionBrickDown && countTime < timeExploring * 3 && checkDown == false) {
                                object.mapObjectNum[(bombY + i * rect) / rect][bombX / rect] = 4;
                                checkDown = true;
                            } else if (collisionBrickDown && countTime >= timeExploring * 3 && checkDown == false) {
                                int num = RandomNumOfObject(NumOfItem);
                                object.mapObjectNum[(bombY + i * rect) / rect][bombX / rect] = num;
                                checkDown = true;
                            }
                        ...
                        if (collisionWallLeft || collisionBrickLeft) {
                            ...
                            if (collisionBrickLeft && countTime < timeExploring * 3 && checkLeft == false) {
                                object.mapObjectNum[(bombY) / rect][(bombX - i * rect) / rect] = 4;
                                checkLeft = true;
                            } else if (collisionBrickLeft && countTime >= timeExploring * 3 && checkLeft == false) {
                                int num = RandomNumOfObject(NumOfItem);
                        ...
                        if (collisionWallRight || collisionBrickRight) {
                            ...
                            if (collisionBrickRight && countTime < timeExploring * 3 && checkRight == false) {
                                object.mapObjectNum[(bombY) / rect][(bombX + i * rect) / rect] = 4;
                                checkRight = true;
                            } else if (collisionBrickRight && countTime >= timeExploring * 3 && checkRight == false) {
                                int num = RandomNumOfObject(NumOfItem);
                                object.mapObjectNum[(bombY) / rect][(bombX + i * rect) / rect] = num;
                                checkRight = true;
